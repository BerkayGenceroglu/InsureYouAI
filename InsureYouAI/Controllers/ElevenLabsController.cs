...
namespace InsureYouAI.Controllers
{
    public class ElevenLabsController : Controller
    {
        ...
        {
            ViewBag.Controller = "Eleven Labs";
            ViewBag.Page = "Sesli Yapay Zeka Asistanı";
            return View();
        }
        ...
        public async Task<IActionResult> SpeakInsuranceAnswer(string text)
        {
            ...
            var apiKey = "sk_0742e1858463c5ece65777c49393a433111a9b6d6e1d9d77";
        ...
        public async Task<IActionResult> SpeakInsuranceAnswer3(string text)
        {
            ...
            ViewBag.Page = "Sesli Yanıt & Akıllı Sohbet Alanı";
