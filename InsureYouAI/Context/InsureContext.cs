...
namespace InsureYouAI.Context
{
    public class InsureContext:IdentityDbContext<AppUser>
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            "Server=DESKTOP-SK0HNP2\\SQLEXPRESS;Initial Catalog=InsureDB;Integrated Security=True;TrustServerCertificate=True;");
        }
        ...
        public DbSet<InsureService> InsureServices { get; set; }
