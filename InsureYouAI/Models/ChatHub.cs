...
namespace InsureYouAI.Models
{
    ...
    {
        private const string apiKey = "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";
...
//Clients.All → Sunucuya bağlı tüm kullanıcılara mesaj gönder
//SendAsync() → Asenkron olarak mesaj gönderme metodu
//"ReceiveMessageEcho" → İstemci tarafında dinlenecek olay adı(method adı)
//UserMessage → Gönderilen veri